  ...
  ("tail-recursive fibonacci function",
   ...
   "define i32 @fib(i32, i32, i32) {
    ...
    ; <label>:11:                                     ; preds = %entry
      ...
      %16 = load i32, i32* %6
      %17 = add i32 %15, %16
      %18 = tail call i32 @fib(i32 %13, i32 %14, i32 %17)
      store i32 %18, i32* %3
      br label %return
    ...
    entry:
      ...
      store i32 %0, i32* %3
      store i8** %1, i8*** %4
      %5 = tail call i32 @fib(i32 10, i32 0, i32 1)
      store i32 %5, i32* %2
      br label %return
